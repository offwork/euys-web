...
export class SaveOrUpdateFormComponent implements OnInit {
  ...
  @Input() anatabloKomboList$: Observable<KtAt2SckHadSarilmaSicakl[]>;
  ...
  @Input() selectedRow: KtSp2SckHadSarilmaSicakl;
  @Input() isFormVisible = true;
  @Input() update!: boolean;
  @Output() formSubmit = new EventEmitter<KtSp2SckHadSarilmaSicakl>();
  ...
  urunler: Urun[];
  celikler: Celik[];
  anatablo: KtAt2SckHadSarilmaSicakl[];
  formData: KtSp2SckHadSarilmaSicakl;
  urunTarget: Urun[];
  celikTarget: Celik[];
  pickListDirty = false;
  ...
  setAnatabloKomboList(anatabloKomboList?: KtAt2SckHadSarilmaSicakl[]): void {
