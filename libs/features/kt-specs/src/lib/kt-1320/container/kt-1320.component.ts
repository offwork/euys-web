...
import { IslemTipi, KtSpCgl12Tavlama2 } from '@euys/api-interfaces';
...
@Component({
  ...
  templateUrl: './kt-1320.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class Kt1320Component implements OnInit, OnDestroy {
  isFormVisible = new BehaviorSubject<boolean>(false);
  selectedRow!: KtSpCgl12Tavlama2;
  _selectedRow = new BehaviorSubject<KtSpCgl12Tavlama2>(null);
  ...
  onUpdateClick(row: KtSpCgl12Tavlama2) {
  ...
  onSubmit(val = {}) {
    ...
    const spesifikasyon: KtSpCgl12Tavlama2 = {
      ...row,
      ...val,
  ...
  rowSelectHandler(selectedRow: KtSpCgl12Tavlama2) {
    this.selectedRow = selectedRow;
  }

  rowUnselectHandler(selectedRow: KtSpCgl12Tavlama2) {
    this.selectedRow = selectedRow;
  }
}
