...
@Injectable()
export class Kt1315Service {
  readonly _endpoint = '/spesifikasyonlar/temper-yuzde-uzamalar';
  ...
  getData(): Observable<ResponseModel<KtSpBobHazTempYuzdeUzamaViewModel>> {
    return this.http
  ...
  saveOrUpdate(
    spesifikasyon: KtSpBobHazTempYuzdeUzama
  ): Observable<ResponseModel<KtSpBobHazTempYuzdeUzama>> {
    if (spesifikasyon.id) {
      return this.http
        .request(
          'PUT',
