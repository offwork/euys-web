...
import { defaultRow } from '../+state/ut-5107.reducer';

@Component({
  selector: 'euys-ut5107',
  templateUrl: './ut-5107.component.html',
})
export class Ut5107Component implements OnInit {
  Visible = UtVisible;
